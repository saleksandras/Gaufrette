...
use Gaufrette\Adapter\GridFSBucket;
use Gaufrette\Filesystem;

class GridFSBucketTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var Filesystem
     */
...
EOF
    ...
    {
        $this->assertEquals(12, $this->filesystem->write('5795f5cc5ae092015648bab4', 'Some content'));
        $this->assertEquals(13, $this->filesystem->write('test/subdir/foo', 'Some content1', true));

        $this->assertEquals('Some content', $this->filesystem->read('5795f5cc5ae092015648bab4'));
        $this->assertEquals('Some content1', $this->filesystem->read('test/subdir/foo'));
        $this->filesystem->delete('5795f5cc5ae092015648bab4');
    ...
    {
        $this->filesystem->write('5795f5cc5ae092015648bab4', 'Some content');
        $this->filesystem->write('5795f5cc5ae092015648bab4', 'Some content updated', true);

        $this->assertEquals('Some content updated', $this->filesystem->read('5795f5cc5ae092015648bab4'));
        $this->filesystem->delete('5795f5cc5ae092015648bab4');
    }
    ...
    {
        $this->assertFalse($this->filesystem->has('5795f5cc5ae092015648bab4'));

        $this->filesystem->write('5795f5cc5ae092015648bab4', 'Some content');

        $this->assertTrue($this->filesystem->has('5795f5cc5ae092015648bab4'));
    ...
    public function shouldGetMtime()
    {
        ...
        $this->assertGreaterThan(0, $this->filesystem->mtime('5795f5cc5ae092015648bab4'));
    ...
    {
        $this->assertFalse($this->filesystem->mtime('5795f5cc5ae092015648bab4'));
    }
    ...
    {
        $this->filesystem->write('5795f5cc5ae092015648bab4', 'Some content');
        $this->filesystem->rename('5795f5cc5ae092015648bab4', 'boo');
        ...
        $this->filesystem->write('5795f5cc5ae092015648bab4', 'Some content');
        $this->filesystem->rename('5795f5cc5ae092015648bab4', 'somedir/sub/boo');
    ...
    public function shouldFetchKeys()
    {
        ...
        $this->filesystem->write('5795f5cc5ae092015648bab4', 'Some content');
        $this->filesystem->write('5795f5d75ae09201584ee271', 'Some content');
        $this->filesystem->write('5795f6145ae092015a5a0a01', 'Some content');

        $actualKeys = $this->filesystem->keys();

        $this->assertEquals(3, count($actualKeys));
        foreach (array('5795f5cc5ae092015648bab4', '5795f5d75ae09201584ee271', '5795f6145ae092015a5a0a01') as $key) {
            $this->assertContains($key, $actualKeys);
        }

        $this->filesystem->delete('5795f5cc5ae092015648bab4');
        $this->filesystem->delete('5795f5d75ae09201584ee271');
        $this->filesystem->delete('5795f6145ae092015a5a0a01');
    }
